...
| Avg reward | 0.5800 |
| Success count | 29 |
| Avg process score | -0.8200 |
| Avg process score, success | 0.7931 |
| Avg process score, failure | -3.0476 |
...
| 14 | 0.0000 | False | -3.5 | `action_mismatch`, `incomplete_evidence`, `premature_write` | `reference_action_mismatch` -2.0<br>`unexpected_write_tool` -1.5 |
...
| 23 | 0.0000 | False | -5.5 | `action_mismatch`, `incomplete_evidence`, `premature_write` | `reference_action_mismatch` -4.0<br>`unexpected_write_tool` -1.5 |
...
| 37 | 0.0000 | False | -6.5 | `action_mismatch`, `communication_db_gap`, `incomplete_evidence`, `premature_write`, `temporal_policy_error` | `reference_action_mismatch` -2.0<br>`unexpected_write_tool` -1.5<br>`cancel_after_24h_without_policy_basis` -3.0 |
...
| 44 | 0.0000 | False | -13.0 | `action_mismatch`, `communication_db_gap`, `incomplete_evidence` | `reference_action_mismatch` -13.0 |
