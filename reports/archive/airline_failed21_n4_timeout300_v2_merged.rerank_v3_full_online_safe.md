...
| 7 | 4 | 0 | t0: 0.0000 / -2.5 | False | t0: 0.0000 / -2.5 | - | r=0.0000, p=-2.5<br>r=0.0000, p=-2.5<br>r=0.0000, p=-4.5<br>r=0.0000, p=-2.5 | `communication_target_miss`, `incomplete_evidence`, `premature_write`, `temporal_policy_error` |
...
| 14 | 4 | 0 | t0: 0.0000 / -2.5 | False | t0: 0.0000 / -2.5 | - | r=0.0000, p=-2.5<br>r=0.0000, p=-11.0<br>r=0.0000, p=-11.0<br>r=0.0000, p=-4.5 | `action_mismatch`, `calculation_error`, `communication_target_miss`, `incomplete_evidence`, `payment_planning_error` |
...
| 18 | 4 | 1 | t0: 0.0000 / -2.0 | True | t2: 1.0000 / 2.0 | t2: 2.0 | r=0.0000, p=-2.0<br>r=0.0000, p=-2.0<br>r=1.0000, p=2.0<br>r=0.0000, p=-2.0 | - |
| 20 | 4 | 1 | t0: 1.0000 / 1.0 | True | t0: 1.0000 / 1.0 | t0: 1.0 | r=1.0000, p=1.0<br>r=0.0000, p=-1.0<br>r=0.0000, p=-1.0<br>r=0.0000, p=-1.0 | - |
| 21 | 4 | 0 | t0: 0.0000 / -2.0 | False | t0: 0.0000 / -2.0 | - | r=0.0000, p=-2.0<br>r=0.0000, p=-2.0<br>r=0.0000, p=-2.0<br>r=0.0000, p=-2.0 | `action_mismatch`, `incomplete_evidence` |
| 23 | 4 | 1 | t0: 0.0000 / -4.0 | True | t1: 1.0000 / 6.0 | t1: 6.0 | r=0.0000, p=-4.0<br>r=1.0000, p=6.0<br>r=0.0000, p=-2.0<br>r=0.0000, p=-13.0 | `calculation_error`, `payment_planning_error` |
...
| 29 | 4 | 0 | t0: 0.0000 / -5.0 | False | t2: 0.0000 / 0.0 | - | r=0.0000, p=-5.0<br>r=0.0000, p=-5.0<br>r=0.0000, p=0.0<br>r=0.0000, p=-2.0 | `action_mismatch`, `incomplete_evidence` |
...
| 44 | 4 | 0 | t0: 0.0000 / -16.5 | False | t3: 0.0000 / -9.0 | - | r=0.0000, p=-16.5<br>r=0.0000, p=-16.5<br>r=0.0000, p=-14.5<br>r=0.0000, p=-9.0 | `action_mismatch`, `incomplete_evidence`, `premature_write` |
