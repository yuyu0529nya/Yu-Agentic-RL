...
| Avg reward | 0.3500 |
| Success count | 7 |
| Avg process score | -4.6750 |
| Avg process score, success | 1.2143 |
| Avg process score, failure | -7.8462 |
...
| 23 | 0.0000 | False | -3.0 | `action_mismatch`, `calculation_error`, `incomplete_evidence`, `payment_planning_error` | `reference_action_mismatch` -3.0<br>`calculation_trace_inconsistent` -1.0<br>`cancel_precondition_supported` +1.0 |
| 23 | 0.0000 | False | -8.5 | `action_mismatch`, `calculation_error`, `communication_db_gap`, `incomplete_evidence`, `payment_planning_error`, `premature_write` | `reference_action_mismatch` -4.0<br>`expected_write_plan_missing` -2.0<br>`calculation_trace_inconsistent` -1.0<br>`unexpected_write_tool` -1.5 |
...
| 23 | 1.0000 | True | 1.0 | `calculation_error`, `payment_planning_error` | `reference_actions_matched` +1.0<br>`calculation_trace_inconsistent` -1.0<br>`cancel_precondition_supported` +1.0 |
